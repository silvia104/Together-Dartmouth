...
<<<<<<< HEAD
 * on 2016-03-04 at 17:47:59 UTC 
=======
 * on 2016-03-04 at 17:53:27 UTC 
>>>>>>> Silvia-EventEditor-Branch
 * Modify at your own risk.
 */

package com.example.tuanmacair.myapplication.backend.messaging;
...
public class Messaging extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  public class MessagingEndpoint {
     ...
     * @return the request
     */
    public SendMessage sendMessage(java.util.List<java.lang.String> deviceList, java.lang.String message) throws java.io.IOException {
      SendMessage result = new SendMessage(deviceList, message);
      initialize(result);
      return result;
    }
    ...
    public class SendMessage extends MessagingRequest<Void> {
      ...
      private static final String REST_PATH = "{deviceList}/{message}";
       ...
       * @since 1.13
       */
      protected SendMessage(java.util.List<java.lang.String> deviceList, java.lang.String message) {
        super(Messaging.this, "POST", REST_PATH, null, Void.class);
        this.deviceList = com.google.api.client.util.Preconditions.checkNotNull(deviceList, "Required parameter deviceList must be specified.");
      ...
      private java.util.List<java.lang.String> deviceList;
      ...
      public SendMessage setDeviceList(java.util.List<java.lang.String> deviceList) {
